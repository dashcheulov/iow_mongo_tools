...
def test_hash_of_segments():
    ...
    template2 = templates.HashOfSegments({'retention': '5D2m4s', 'segment_separator': ':', 'segment_field_name': 'sg'})
    ...
    assert template2.config == {'retention': 432124, 'segment_separator': ':', 'segment_field_name': 'sg'}
    assert template2.apply({'sg': '2341:2452_4234'}) == {'2341': expiration_ts2,
