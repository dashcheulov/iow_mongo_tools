...
def test_create_objects():
    ...
    cluster.create_objects(('gce-eu', 'aws-va'), {'gce-eu': sample_cluster_config, 'aws-va': {'mongos': ['l:27017']}})
...
def test_create_objects_with_partial_config():
    cluster.Cluster.objects = dict()  # erase objects left from previous test
    cluster.create_objects(('gce-sc', 'aws-jp'), {'aws-jp': sample_cluster_config})
